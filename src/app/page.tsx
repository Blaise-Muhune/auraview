  ...
  return (
    <div className="min-h-screen bg-gray-50 mystical-bg relative overflow-hidden">
      ...
      <nav className="relative z-10 flex justify-between items-center p-6 text-gray-700">
        <div className="text-2xl font-bold mystical-text">✧ Aura ✧</div>
      ...
      <main className="relative z-10 container mx-auto px-6 py-20">
        <div className="text-center text-gray-700 mb-16">
          <div className="mb-8">
            <div className="text-6xl mb-4 mystical-text font-bold">✧ Aura ✧</div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link href="/signup" className="px-8 py-4 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-lg text-white font-semibold text-lg hover:from-purple-600 hover:to-cyan-600 transition-all shadow-lg">
              Start Ranking
            </Link>
            <Link href="/leaderboard" className="px-8 py-4 border-2 border-gray-300 rounded-lg text-gray-700 font-semibold text-lg hover:border-purple-400 hover:bg-purple-50 transition-all">
              View Rankings
            </Link>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8 max-w-xl mx-auto">
            <div className="text-center">
              <div className="text-2xl font-bold mystical-text">10,000</div>
              <div className="text-gray-500 text-sm">Points</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold mystical-text">500</div>
              <div className="text-gray-500 text-sm">Base</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold mystical-text">∞</div>
        ...
        <div className="text-center text-gray-700">
          <Link href="/signup" className="inline-block px-10 py-4 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-lg text-white font-semibold text-xl hover:from-purple-600 hover:to-cyan-600 transition-all shadow-lg">
            Create Your Account
          </Link>
        </div>
      </main>
      ...
      <footer className="relative z-10 border-t border-gray-200 mt-20 bg-white">
        <div className="container mx-auto px-6 py-8">
          <div className="text-center text-gray-500">
            <div className="text-lg font-semibold mystical-text">✧ Aura ✧</div>
          </div>
        </div>
      </footer>
    </div>
